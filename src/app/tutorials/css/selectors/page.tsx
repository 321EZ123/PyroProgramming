  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <ul className="list-disc pl-6 mb-4">
        <li><strong>Element:</strong> selects all elements of a given type, e.g., <code className="bg-card/50 px-1 rounded">p</code></li>
        <li><strong>Class:</strong> selects elements with a specific class, e.g., <code className="bg-card/50 px-1 rounded">.example</code></li>
        <li><strong>ID:</strong> selects a unique element by ID, e.g., <code className="bg-card/50 px-1 rounded">#header</code></li>
        <li><strong>Attribute:</strong> selects elements with a specific attribute, e.g., <code className="bg-card/50 px-1 rounded">input[type="text"]</code></li>
      </ul>
