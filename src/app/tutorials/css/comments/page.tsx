...
export default function CssComments() {
  const mainContainerStyles = `/* Main container styles */
.container {
  width: 100%;
  padding: 20px;
}
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <p className="text-lg mb-4">
        Comments in CSS are written using <code className="bg-card/50 px-1 rounded">/* comment text */</code>.
      </p>
