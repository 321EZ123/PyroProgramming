  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <p className="text-lg mb-4">
        Automatic conversion from smaller to larger types, e.g., <code>int</code> to <code>long</code>.
      </p>
      ...
      <p className="text-lg mb-6">
        Use <code>instanceof</code> to check before downcasting between object types.
      </p>
    </div>
  );
}
