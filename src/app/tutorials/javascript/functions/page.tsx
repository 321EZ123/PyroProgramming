  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <p className="text-lg mb-4">
        Declare functions using <code className="bg-card/50 px-1 rounded">function myFunc() {}</code> or expressions <code className="bg-card/50 px-1 rounded">const myFunc = function() {}</code>.
      </p>

      <h2 className="text-3xl font-semibold mb-4">Parameters and Return Values</h2>
      <p className="text-lg mb-4">
        Functions can accept parameters and return values using <code className="bg-card/50 px-1 rounded">return</code>.
      </p>

      <h2 className="text-3xl font-semibold mb-4">Arrow Functions</h2>
      <p className="text-lg mb-4">
        Shorter syntax: <code className="bg-card/50 px-1 rounded">const add = (a, b) => a + b;</code>.
      </p>
